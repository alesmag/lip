...
let%test "zero_one_same_2" = derive same_amount [ 1; 0; 4; ] |> to_string = "1001"
let%test "zero_one_same_3" = derive same_amount [ 2; 0; 1; 3; 4; ] |> to_string = "00110101"
let%test "zero_one_same_4" = derive same_amount [ 3; 2; 2; 2; 4; ] |> to_string = "10001110"
